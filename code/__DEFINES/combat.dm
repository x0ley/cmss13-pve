...
#define MELEE_FORCE_TIER_12 100
#define MELEE_FORCE_TIER_13 125
#define MELEE_FORCE_TIER_14 170
#define MELEE_FORCE_TIER_15 250

#define MELEE_FORCE_WEAK MELEE_FORCE_TIER_2
#define MELEE_FORCE_NORMAL MELEE_FORCE_TIER_5
#define MELEE_FORCE_STRONG MELEE_FORCE_TIER_10
#define MELEE_FORCE_VERY_STRONG MELEE_FORCE_TIER_12
